...
test_size = st.sidebar.slider("Доля тестовой выборки (test_size)", 0.1, 0.5, 0.3, 0.05)
...
max_iter = st.sidebar.slider("Максимальное число итераций (Logistic Regression)", 100, 1000, 565, 5)
